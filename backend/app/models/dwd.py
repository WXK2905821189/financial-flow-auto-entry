...
from sqlalchemy import DECIMAL, JSON, BigInteger, Date, DateTime, ForeignKey, Integer, String, Time, func
...
class FlowBatch(Base):
    ...
    balance_check_status: Mapped[str] = mapped_column(String(8), nullable=False, default="SKIP")
